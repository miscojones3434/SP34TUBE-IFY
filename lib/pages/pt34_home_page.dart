...
///
/// Esta pantalla no modifica el reproductor, los metadatos,
/// YouTube Audio ni ninguna función original de Spotube.
@RoutePage()
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(12),
                    const Text(
                      'Desde aquí se integrarán Mi actividad, Mis canciones, '
                      'Crear música con IA, distribución musical y perfil PT34.',
                    ),
                    const Gap(24),
                    const Text(
                      'Motores originales conservados',
                    ).h3(),
                    const Gap(12),
                    const Text(
