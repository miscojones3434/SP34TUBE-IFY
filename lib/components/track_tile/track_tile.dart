...
class TrackTile extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // La selección puede activarse expresamente mediante selectionMode
    // o implícitamente al proporcionar onChanged.
    final effectiveSelection =
        selectionMode || onChanged != null;

    const activeGreen = Color(0xFF1ED760);
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Listener(
          ...
          child: HoverBuilder(
            permanentState:
                isSelected || constraints.smAndDown ? true : null,
                ...
                leading: Row(
                  ...
                  children: [
                    ...
                    AnimatedCrossFade(
                      ...
                      secondChild: constraints.smAndDown
